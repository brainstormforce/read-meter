...
if ( ! class_exists( 'BSFRT_Loader' ) ) :
	...
	class BSFRT_Loader {
		...
		public function bsfrt_pluginstyle_frontend() {
			...
			wp_register_style( 'bsfrt_frontend', BSF_RT_PLUGIN_URL . '/assets/css/bsfrt-frontend-css.css', null, '1.0' );
			wp_register_script( 'bsfrt_frontend', BSF_RT_PLUGIN_URL . '/assets/js/bsf-rt-frontend.js', null, '1.0', false );
		...
		public function bsfrt_pluginstyle_dashboard() {
			...
			wp_register_style( 'bsfrt_dashboard', BSF_RT_PLUGIN_URL . '/assets/css/bsfrt-admin-dashboard-css.css', null, '1.0' );

			wp_register_script( 'bsfrt_backend', BSF_RT_PLUGIN_URL . '/assets/js/bsf-rt-backend.js', null, '1.0', false );

			wp_register_script( 'colorpickerscript', BSF_RT_PLUGIN_URL . '/assets/js/color-picker.js', array( 'jquery', 'wp-color-picker' ), '1.0', true );
		}
	}
