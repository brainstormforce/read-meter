...
<div class="bsf_rt_user_manual">
	<br><label class="bsf_rt_page_title" for="howtouse">
		<?php
		echo __( 'How to Use? </label><br><br>
	...
	<b> Shortcode : [read_meter]</b> <br><br>
		You can also display the reading time wherever you want by using this shortcode , You just need to copy it and paste it in any content of Post or Page.', 'read-meter' );
		?>
</div>
