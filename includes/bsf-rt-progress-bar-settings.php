...
<form action="" method="post" name="bsf_rt_settings_form">
	<table class="form-table">
		<br>
		<p class="description">
			<?php esc_attr_e( 'Control the position & appearance of the progress bar. Progress bar acts with the content that the user has read. (Note : The Progress Bar will only display on Singular Posts or Pages)', 'read-meter'  ); ?>
		</p> 
		<tr>
		<th scope="row"> 

			<label for="PositionofDisplayProgressBar"><?php esc_attr_e( 'Display Position', 'read-meter' ); ?> :</label>
			...
			<select required id="bsf_rt_position_of_progress_bar" name="bsf_rt_position_of_progress_bar" >
				...
				if ( isset( $bsf_rt_position_of_progress_bar ) ) {
					...
					if ( 'top_of_the_page' === $bsf_rt_position_of_progress_bar ) {
						...
						esc_attr_e( 'Top of the Page', 'read-meter' );
						echo '</option>';
					} else {
					...
					if ( 'bottom_of_the_page' === $bsf_rt_position_of_progress_bar ) {
						...
						esc_attr_e( 'Bottom of the Page', 'read-meter' );
						echo '</option>';
					} else {
	...
	<table class="form-table" id="bsf-rt-progress-bar-options" <?php echo wp_kses_post( $bsf_rt_progress_display ); ?>>  
		<tr>
	<th scope="row"> 
			<label for="ProgressBarStyle"><?php esc_attr_e( 'Styles', 'read-meter' ); ?> :</label>
	</th>
			<td>
			<select  name="bsf_rt_progress_bar_styles" id="bsf_rt_progress_bar_styles">
					...
					if ( isset( $bsf_rt_progress_bar_styles ) ) {
						...
						if ( 'Gradient' === $bsf_rt_progress_bar_styles ) {
							...
							esc_attr_e( 'Gradient', 'read-meter' );
							echo '</option>';
		...
		<tr id="normal-back-wrap">
			...
			<label for="ProgressBarBackgroundColor"><?php esc_attr_e( 'Background Color', 'read-meter' ); ?> :</label>
		...
		<tr id="normal-color-wrap">
			<th scope="row">
			<label for="ProgressBarColor"> <?php esc_attr_e( 'Primary Color', 'read-meter' ); ?> :</label>
			</th>  
			<td>
				<?php
		...
		<tr id="gradiant-wrap2" <?php echo wp_kses_post( $bsf_rt_progress_color_display ); ?>>
			<th scope="row">
				<label for="ProgressBarColor"> <?php esc_attr_e( 'Secondary Color', 'read-meter' ); ?> :</label>
			</th>
			<td>
					<?php
		...
		<tr>
			...
			<label for="Thickness"><?php esc_attr_e( 'Bar Thickness', 'read-meter' ); ?> :</label>
